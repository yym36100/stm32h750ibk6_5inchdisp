...
u8 QSPI_Init(void)
{
	...
	GPIO_Set(GPIOF,0XF<<7,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PF6~9复用功能输出	
	GPIO_Set(GPIOF,0XF<<8,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PF6~9复用功能输出	
	GPIO_Set(GPIOF,0XF<<9,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PF6~9复用功能输出	
